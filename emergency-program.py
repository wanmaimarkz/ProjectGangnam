...
def main():
    """find location"""
    import folium
    map = folium.Map(location=[13.7278956, 100.52412349999997], zoom_start=13)
    #5678dslfdsklfdskflds;flkds
    police_station = [
    ...
    private_hospitals_no_card = [
                    ...
                    ['โรงพยาบาลวิภาวดี', 113.846311142237711, 100.56208972491727],
                    ...
                    ['โรงพยาบาลสถาบันโรคไตภูมิราชนครินทร์', 13.760023925190582, 100.53462003952916],
    ...
    government_hospital_no_card =  [
                    ...
                    ['สถาบันสุขภาพเด็กมหาราชินี', 13.765858840785333, 100.53522749328764],
    ...
    #มาคตำแหน่งที่เราต้องการ
    for loc_hotpi in police_station:
        folium.Marker([loc_hotpi[1], loc_hotpi[2]], popup=loc_hotpi[0], 
    ...
    for loc_pv_hospi_no_card in private_hospitals_no_card:
        folium.Marker([loc_pv_hospi_no_card[1], loc_pv_hospi_no_card[2]], 
                    popup=loc_pv_hospi_no_card[0], icon=folium.Icon(color='red', icon="plus")).add_to(map)
